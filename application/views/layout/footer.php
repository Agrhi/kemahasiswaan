    ...
    <div class="row align-items-center justify-content-lg-between">
      <div class="col-lg-6 mb-lg-0 mb-4">
        <div class="copyright text-center text-sm text-muted text-lg-start">
          2024
          &copy; Copyright
          <a href="https://www.instagram.com/agrhi_/" class="font-weight-bold" target="_blank">Desa Panasibaja</a>
        </div>
      </div>
    </div>
  </div>
  ...
  function btnhapus(act, kode) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        document.location.href = '<?= base_url() ?>' + act + '/delete/' + kode;
      }
    });
  }
