                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($value->status == 1) { ?>
                                    <a href="<?= base_url('management_user/status/nonaktif/') . $value->iduser ?>" class="btn btn-primary btn-sm">Aktif</a>
                                <?php } else { ?>
                                    <a href="<?= base_url('management_user/status/aktif/') . $value->iduser ?>" class="btn btn-danger btn-sm">Tidak Aktif</a>
                                <?php } ?>
                            </td>
                            <td>
                                <button class="btn btn-success btn-sm" data-bs-toggle="modal" onclick="updateuser('<?= $value->iduser ?>')" data-bs-target="#modaledit"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
